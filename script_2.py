...
def train_and_evaluate(batch_size=8, img_dir='mess_cb',
	...
	callbacks1 = [checkpointer, early1]     # For initial tuning
	callbacks2 = [checkpointer, early2]     # For fine tuning

	model.fit_generator(train_it, train_len, epochs, validation_data=val_it, validation_steps=192, verbose=2, callbacks=callbacks1)
