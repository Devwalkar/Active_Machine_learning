...
######################################################################################################
Expt_load = 'exp_M_10.hdf5'
Expt_save = 'exp_M_10.hdf5'
LOAD_MODEL = False
No_images_to_add = 10
Initial_dataset = 100
####################################################################################################3
...
def train_and_evaluate(batch_size=8, img_dir='mess_cb',
	...
	early2 = EarlyStopping(monitor = 'val_acc',patience=3, verbose=1)
...
if __name__ == '__main__':
	...
	if LOAD_MODEL==True:
		...
		X_train = np.reshape(X_train[:Initial_dataset,:,:,:],(Initial_dataset,3,512,512))
		Y_train = np.reshape(Y_train[:Initial_dataset],(Initial_dataset,))		
